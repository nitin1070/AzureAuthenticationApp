...
<html lang="en">
  ...
  <div class="site-wrap">
                  ...
                  <div class="d-inline-block d-lg-none ml-md-0 mr-auto py-3"><a href="#" class="site-menu-toggle js-menu-toggle text-black"><span class="icon-menu h3"></span></a></div>
                   ...
                   <ul class="site-menu js-clone-nav d-none d-lg-block">
                    <li class="has-children active"></li>
                     <li><a href="${pageContext.request.contextPath}/AdminPageServlet">Home</a></li>
                   
                    <li><a href="${pageContext.request.contextPath}/PageController?action=services">Services</a></li>
                     <li><a href="${pageContext.request.contextPath}/PageController?action=contact">Contact</a></li>
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url(images/worker-oil-rig-sunset-created-with-generative-ai-technology.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-7">
