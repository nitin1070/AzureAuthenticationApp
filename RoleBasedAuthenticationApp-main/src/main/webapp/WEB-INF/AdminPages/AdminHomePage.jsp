  ...
  <div class="site-navbar-wrap bg-white">
    ...
    <div class="site-navbar bg-light">
      <div class="container py-1">
        <div class="row align-items-center">
          <div class="col-2">
<%--             <a href="${pageContext.request.contextPath}/AdminPageServlet"><img src="images/logo.png"> Altered Security</a> --%>
          
                      <a href="#"><img src="images/logo.png"> Altered Security</a>
          </div>
          <div class="col-10">
...
<%--                     <a href="${pageContext.request.contextPath}/PageController?action=contact">Contact</a> --%>
                   ...
                   <a href="${pageContext.request.contextPath}/EmailSenderServlet">Add User</a>
...
<div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 bg-image bg-sm-height mb-5 mb-md-0 order-md-2" style="background-image: url('${pageContext.request.contextPath}/JSP_JS_CSS/images/img_1_colored.jpg');" data-aos="fade-up"></div>
          <div class="col-md-6 pr-md-5 order-md-1">
            ...
            <p><a href="#" class="btn btn-outline-primary btn-sm rounded-0 p-2 px-4">Add User</a></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <%-- <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(${pageContext.request.contextPath}/JSP_JS_CSS/images/chris-leboutillier-TUJud0AWAPI-unsplash.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(${pageContext.request.contextPath}/JSP_JS_CSS/images/home2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">Specialized Technical <strong>Solutions</strong></h1>
